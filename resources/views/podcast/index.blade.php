@extends('layout.layout')
    ...
    @extends('layout.navbar')
                ...
                <section  >
                    <div class="intro">
                        ...
                        <div class=" ">
                            ...
                            <div class="container">
                            <div class="  row" >
                                <div class="col-lg-6 col-md-6 col-sm-6  intro-container">
                                    <h2 class="intro-headline ">
                                     Addressing Serious Social Issues in a Jovial way
                                    </h2>
                                    <p class="intro-desc">Let's discuss issues facing humanity in a more relief way. sit back, relax and enjoy!  <br></p>
                                    @if (auth()->guest())
                                    <a title="Let's get talking" class="btn  btn-lg contactbtn btns" href="{{URL::to('/login')}}">Login</a>
                                    @else
                                        
                                    @endif
                                    <a title="See the list of discusions we had" class="btn  btn-lg btnl " href="{{URL::to('/podcasts')}}"  >See Podcasts</a>

                                    <div class="mt-4 icon-container " >
                                    <a class=" icons" href="https://web.facebook.com/mdain/" target="_blank"> <i class="fa fa-facebook-square fa-2x mr-1"></i></a>
                                    <a class=" icons" href="https://twitter.com/mdain_" target="_blank"><i class="fa fa-twitter-square fa-2x mr-1"></i></a>
                                    <a class=" icons" href=" https://www.linkedin.com/company/10888332/admin/" target="_blank"><i class="fa fa-linkedin-square fa-2x mr-1"></i></a>
                                   
                                    </div>
                                </div>
                            
                                <div class="col-lg-6 col-md-6 col-sm-6 intro-img-container">
                                  <svg width="758" height="744" viewBox="0 0 758 744" fill="none" xmlns="http://www.w3.org/2000/svg" class="">
                                    <g id="podcast 1" clip-path="url(#clip0)">
                                    <path id="Vector" d="M91.4532 0C82.9692 0.00952843 74.8354 3.38401 68.8363 9.38311C62.8372 15.3822 59.4627 23.516 59.4532 32V710.428C59.4628 718.912 62.8373 727.045 68.8364 733.044C74.8355 739.044 82.9692 742.418 91.4532 742.428H388.453C396.937 742.418 405.07 739.043 411.069 733.044C417.068 727.045 420.443 718.912 420.453 710.428V32C420.443 23.516 417.069 15.3823 411.069 9.38321C405.07 3.38413 396.937 0.00962088 388.453 0H91.4532Z" fill="#E6E6E6"/>
                                    <path id="Vector_2" d="M400.658 156.982V102.542C383.746 98.6579 367.826 91.3022 353.906 80.941C339.987 70.5799 328.372 57.4395 319.799 42.353L319.798 42.354C315.685 45.4037 310.698 47.045 305.578 47.034H262.35C273.885 75.784 292.701 101.038 316.951 120.315C341.2 139.592 370.047 152.228 400.658 156.982V156.982Z" fill="white"/>
                                    <path id="Vector_3" d="M400.658 99.4219V47.1241C400.659 43.2984 399.907 39.5099 398.443 35.9752C396.98 32.4404 394.834 29.2287 392.129 26.5235C389.423 23.8183 386.212 21.6726 382.677 20.2091C379.142 18.7456 375.354 17.9929 371.528 17.9941H329.558V23.0441C329.562 26.283 328.909 29.4891 327.637 32.4679C326.365 35.4466 324.502 38.136 322.159 40.373C330.451 55.1069 341.709 67.9614 355.22 78.1249C368.731 88.2884 384.203 95.54 400.658 99.4219V99.4219Z" fill="white"/>
                                    <path id="Vector_4" d="M198.769 47.0341H171.738C165.377 47.0323 159.277 44.5038 154.78 40.0049C150.283 35.5061 147.757 29.4052 147.758 23.0441V17.9941H108.378C104.553 17.9938 100.764 18.747 97.2301 20.2108C93.6957 21.6746 90.4843 23.8203 87.7793 26.5254C85.0742 29.2304 82.9285 32.4418 81.4647 35.9762C80.0009 39.5105 79.2477 43.2986 79.248 47.1241V695.324C79.2439 699.15 79.9948 702.939 81.4575 706.473C82.9202 710.008 85.0661 713.22 87.7721 715.924C90.4782 718.628 93.6912 720.772 97.2272 722.232C100.763 723.693 104.552 724.441 108.378 724.434H371.528C372.728 724.437 373.927 724.363 375.118 724.214C382.163 723.336 388.646 719.916 393.348 714.596C398.051 709.277 400.65 702.424 400.658 695.324V218.152C304.949 207.062 225.2 138.773 198.769 47.0341Z" fill="white"/>
                                    <path id="Vector_5" d="M259.07 47.0341H201.929C228.23 137.073 306.609 204.062 400.658 215.102V160.082C369.229 155.276 339.611 142.307 314.765 122.469C289.919 102.631 270.714 76.6195 259.07 47.0341V47.0341Z" fill="white"/>
           ...
           <section class="latest-podcast">
           <div class="container">
            <h3  style="margin-top:2px">{{count($newpodcasts)<=0?"":"Latest Posts"}}</h3>
           </div>
            <div class="container  ">
            
                <div class="row">
                  @foreach ($newpodcasts as $item)
           ...
           <section id="popular-podcast">
            <div class="container mt-5">
                <h3 style="color: #243447">{{count($popularpodcasts)<=0?"":"Popular Posts"}}</h3>
                <div class="row">
                    
                  @foreach ($popularpodcasts as $item)
                  <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="story-container" >
                        <img  src="{{$item->cover_art?URL::to($item->cover_art): URL::asset('img/tape.jpg') }}"  alt="" class="card-img-top podcast-img">
       ...
       <section id="whyus-container">
         ...
         <div class="container ">
          <h3 class="whyus-text  ">Why come here?</h3>
          <div class="row">
              
            <div class="col-lg-4 col-md-4">
              <div class="whyus" >
                  <h3 ><i class="fa fa-grin-tongue-wink fa-2x"></i></h3>
                  
                  <div class="">
                   
                  <p class="card-text "> We are definetely here to take your head of the stress</p>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="whyus" >
                <h3><i class="fa fa-grin-wink fa-2x"></i></h3>
                
                <div class="">
                 
                <p class="card-text "> We are here to help you learn one or two things about everything </p>
        ...
        <div class="col-lg-4 col-md-4">
          <div class="whyus" >
              <h3><i class="fa fa-meh-rolling-eyes fa-2x"></i></h3>
              
              <div class="">
               
              <p class="card-text "> We are here to help one another address serious issues in jovial way.</p>
